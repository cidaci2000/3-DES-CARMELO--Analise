...
$sql = "SELECT nomecliente, cpf, endereco, telefone, celular, email, senha, tipo
        FROM cliente
        WHERE nomecliente LIKE '%$searchTerm%' 
...
<br>
<button><a href="administrador.php">Administrador</a></button>
